...
import com.liwenguang.dingtalk.service.asyncsend.BadSmellCodeResponse;
import com.liwenguang.dingtalk.service.asyncsend.BadSmellCodeResponse2;
...
public class BadSmellCodeUtil {
    ...
    public static AsyncSendResponse to(AsyncSendResponse asyncSendResponse, BadSmellCodeResponse badSmellCodeResponse) {
    ...
    public static AsyncSendResponse to(AsyncSendResponse asyncSendResponse, BadSmellCodeResponse2 badSmellCodeBean) {
    ...
    public static AsyncSendResponse to(AsyncSendResponse asyncSendResponse, String response) {
        ...
        if (response.startsWith("{\"e")) {
            return to(asyncSendResponse, JSON.parseObject(response, BadSmellCodeResponse2.class));
        } else {
            return to(asyncSendResponse, JSON.parseObject(response, BadSmellCodeResponse.class));
        }
    }
}